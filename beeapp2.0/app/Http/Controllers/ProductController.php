...
class ProductController extends Controller
{
    ...
    public function show(Product $product,$id)
    {
        ...
        // return view('layouts.products.show',compact('products'));
        $producers=
        Producer::join("products","producers.productor_id","=","products.id")
        ->where("id",$product->id)
        ->select("producers.razon_social","producers.email_prod")
        ->get();
        return view('layouts.products.show',compact('producers','product'));
    }
