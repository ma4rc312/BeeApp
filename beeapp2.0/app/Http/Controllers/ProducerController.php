...
class ProducerController extends Controller
{
    ...
    {
        // $products=
        // Product::join("producers","products.id","=","producers.id")
        // ->where("id",$producer->id)
        // ->select("products.nombre_producto","products.fecha_producto")
        // ->get();
        // return view('producers.show',compact('products','producer'));
    }
