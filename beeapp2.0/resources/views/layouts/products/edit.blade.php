...
@section('content')
    <h2>Edición del producto No. {{ $product->id }}</h2>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-4 col-sm-2">
                    ...
                    <input type="text" name="descripcion_producto" value="{{ $product->descripcion_producto }}">
                    <br><br>
                ...
                <div class="col-md-6 col-lg-6 col-sm-12">
                    ...
                    <span class="btn btn-secondary btn-file">
                        ...
                        <input accept="image/*" value="{{$product->imagen_producto}}" onchange="vistaPrevia(event)"type="file" name="imagen_producto" >
                    </span>
                    <small class="text-danger">{{ $errors->first('imagen_producto') }}</small>
                </div>

                <div class="imagen col-md-6 col-lg-6col-sm-12">
                  <label for="">Vista previa imagen:</label><br>
                  <img src="{{asset('img/'.$product->imagen_producto )}}" id="img-foto" alt="">
              </div>

                <div class="col-lg-6 col-md-4 col-sm-2">
                    <label for="">Cantidad: </label><br>
                    <input type="date" name="cantidad_producto" value="{{ $product->cantidad_producto }}">
                    <br><br>
                ...
                <div class="col-lg-6 col-md-4 col-sm-2">
                    ...
                    <input type="date" name="fecha_producto" value="{{ $product->fecha_producto }}">
                    <br><br>
                ...
                <div class="col-lg-6 col-md-4 col-sm-2">
                    ...
                    <input type="date" name="fecha_ven_producto" value="{{ $product->fecha_ven_producto }}">
                    <br><br>
                ...
                <div class="col-lg-6 col-md-4 col-sm-2">
                    ...
                    <input type="text" name="estado_producto" value="{{ $product->estado_producto }}">
                    <br><br>
...
@section('css')
    ...
    <style type="text/css">
    img {
             width: 300px;/* ANCHO_IMAGEN */
             border: solid silver 1px;
             height: 300px;/* ALTO_IMAGEN */
