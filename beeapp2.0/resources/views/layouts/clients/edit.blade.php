        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-4 col-sm-2">
                    ...
                    <input type="text" name="nombres_us" value="{{ $client->nombres_us }}">
                    <br><br>
                </div>

                <div class="col-lg-6 col-md-4 col-sm-2">
                    <label for="">Apellido: </label><br>
                    <input type="text" name="apellidos_us" value="{{ $client->apellidos_us }}">
                    <br><br>
                </div>

                <div class="col-lg-6 col-md-4 col-sm-2">
                    <label for="">Identificacion: </label><br>
                    <input type="text" name="identificacion_us" value="{{ $client->identificacion_us }}">
                    <br><br>
                </div>

                <div class="col-lg-6 col-md-4 col-sm-2">
                    <label for="">Telefono: </label><br>
                    <input type="text" name="telefono_us" value="{{ $client->telefono_us }}">
                    <br><br>
                </div>

                <div class="col-lg-6 col-md-4 col-sm-2">
                    <label for="">Email: </label><br>
                    <input type="text" name="email_us" value="{{ $client->email_us }}">
                    <br><br>
                </div>

                <div class="col-lg-6 col-md-4 col-sm-2">
                    <label for="">Password: </label><br>
                    <input type="text" name="password_us" value="{{ $client->password_us }}">
                    <br><br>
                </div>
