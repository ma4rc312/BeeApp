        ...
        <div class="container" style="margin-top: 80px">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    ...
                    @else
                        <h4>No Hay Producto(s) En Tu Carro</h4><br>
                    ...
                    @foreach ($cartCollection as $item)
                        <div class="row">
                            <div class="col-lg-3">
                                <img src="/img/{{ $item->attributes->image }}" class="img-thumbnail" width="200"
                                    height="200">
                            </div>
                            <div class="">
                                <p>
                                    <b><a class="nombre_p">{{ $item->name }}</a></b><br>
                ...
                <ul style="margin: 20px;">
                    ...
                    <form action="{{ route('cart.clear') }}" method="POST">
                        {{ csrf_field() }}
                        <button class="fondo2">Borrar Carrito</button>
